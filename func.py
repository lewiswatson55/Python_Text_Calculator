def getNum(): #ask for two numbers and then return to function
    ...
    log(("Palc got two numbers: ", n1, ", and ", n2))
    return n1, n2
def help():
    print('''
...
def multi(): #multiplication
    ...
    print("\nThat equals...")
    print(n1 * n2)
    log(("User multiplied ", n1, " by ", n2, " and got result ", (n1 * n2)))
def div(): #division
    n1, n2 = getNum()
    print("\nThat equals...")
    print(n1 / n2)
    log(("User divided ", n1, " by ", n2, ", getting a result of ", (n1 / n2)))
def sub(): #subtraction
    n1, n2 = getNum()
    print("\nThat equals...")
    print(n1 - n2)
    log(("User subtracted ", n1, " to ", n2, " and got result ", (n1 - n2)))
def add(): #addition
    n1, n2 = getNum()
    print("\nThat equals...")
    print(n1 + n2)
    log(("User added ", n1, " to ", n2, " and got result ", (n1 + n2)))
def mod(): #modulo
    try:
        ...
        log(("ERROR: attempted to modulo numbers ", bigger, " and ", smaller, ", but errored code 1."))
    if(abs(bigger)<abs(smaller)):
        print("\nError!")
        print("The second number entered is greater than the first number (code 2)\n")
        log(("ERROR: attempted to modulo numbers ", bigger, " and ", smaller, ", but errored code 2."))
    else:
        print("\nThat equals...")
        print(bigger-smaller*int(bigger/smaller))
        log(("User attempted to modulo numbers ", bigger, " and ", smaller, ", and got result ", (bigger-smaller*int(bigger/smaller))))
        print()
def base():
...
def readMyMemory():
    ...
    try:
        ...
        log(("Retrieved number ", memory.read(), " from memory."))
    except:
        log("There was an error retrieving the file from memory.")
